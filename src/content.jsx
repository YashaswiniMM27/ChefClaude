    ...
    return(
        <div className="wrapper">
            ...
            <section className="ingredientsSection">
                ...
                {ingredients.length > 0 && <ul>{ingredientsList}</ul>}
            ...
            {ingredients.length > 3 && <div className="getRecipeContainer">
                ...
                <button className="recipeButton" onClick={IsRecipeShown}>Get a recipe</button>
                </div>}
            {recipeShown && <article className="suggested-recipe-container">
                <h2>Chef Claude Recommends:</h2>
                <p>Based on the ingredients you have available, I would recommend making a simple a delicious <strong>Beef Bolognese Pasta</strong>. Here is the recipe:</p><br />
